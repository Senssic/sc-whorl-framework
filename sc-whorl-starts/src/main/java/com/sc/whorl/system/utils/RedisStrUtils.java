...
public class RedisStrUtils {
    ...
    public RedisStrUtils(StringRedisTemplate redisTemplate) {
    ...
    public boolean setBit(String key, long offset, boolean value) {
        return Optional.ofNullable(redisTemplate.opsForValue().setBit(key, offset, value)).get();
    }
    ...
    public boolean setIfAbsent(String key, String value) {
        return Optional.ofNullable(redisTemplate.opsForValue().setIfAbsent(key, value)).get();
    }
    ...
    public boolean multiSetIfAbsent(Map<String, String> maps) {
        return Optional.ofNullable(redisTemplate.opsForValue().multiSetIfAbsent(maps)).get();
    }
